...
auto_answer_prompt = (
    ...
    "same answer. A brief acknowledgement or backchannel such as 'ok', 'hmm', or 'uh-huh' "
    "does not need its own answer when it adds no new question, constraint, correction, or "
    "clarification. If a previous visible answer is provided, return it exactly for such "
    "an acknowledgement. If a brief statement adds information, minimally update the same "
    "answer instead. Do not answer the latest desktop transcript merely because it is last. "
...
auto_answer_revision_prompt = (
    ...
    "turn is only a brief acknowledgement or backchannel such as 'ok', 'hmm', or "
    "'uh-huh' and adds no new question, constraint, correction, or clarification, "
    "return the previous visible answer exactly. If a brief statement does add "
    "information, minimally update the same answer. For any other turn that does "
    "not require a change, return the previous visible answer exactly. "
